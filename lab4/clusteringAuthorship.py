...
def get_args():
    ...
    parser.add_argument('-f1', '--gt_fn', help='.txt data: <doc name>,<author>', required=True)
    parser.add_argument('-f2', '--vec_fn', help='.txt data with doc t_idfs', required=True)
